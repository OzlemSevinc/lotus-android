...
class _ArticleListState extends State<ArticleList> {
  List<Article> articleList = [
    Article(title: "Makale1",
        ...
        writer: "Yazar1",
        category: "Kategori1"),
    Article(title: "Makale2",
        content: "İçerik2",
        writer: "Yazar2",
        category: "Kategori2"),
    Article(title: "Makale3",
        content: "İçerik3",
        writer: "Yazar3",
        category: "Kategori3"),
    Article(title: "Makale4",
        content: "İçerik4",
        writer: "Yazar4",
        category: "Kategori4"),
    Article(title: "Makale5",
        content: "İçerik5",
        writer: "Yazar5",
        category: "Kategori5"),
    Article(title: "Makale6",
        content: "İçerik6",
        writer: "Yazar6",
        category: "Kategori6"),
    Article(title: "Makale7",
        content: "İçerik7",
        writer: "Yazar7",
        category: "Kategori7"),
    Article(title: "Makale8",
        content: "İçerik8",
        writer: "Yazar8",
        category: "Kategori8"),
  ];
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Yazar: ${article.writer}", style: TextStyle(
                                fontSize: 16)),
